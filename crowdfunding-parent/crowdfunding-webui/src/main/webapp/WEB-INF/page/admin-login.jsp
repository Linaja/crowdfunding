...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <form class="col-md-4" method="post" action="${pageContext.request.contextPath}/admin/login">
            <h3 class="text-center text-primary">登录</h3>
            <form role="form">
                <div class="form-group">
                    <label for="textInputEmail1">账号</label>
                    <input type="text" class="form-control" id="textInputEmail1" name="account" autocomplete="off"
                           value="123456789"/>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">密码</label>
                    <input type="password" class="form-control" id="exampleInputPassword1" name="password"
                           autocomplete="off" value="001257"/>
                </div>
